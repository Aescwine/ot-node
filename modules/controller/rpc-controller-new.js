...
class RpcControllerNew {
    ...
    initializeApiRoutes() {
        // assets
        this.app.post('/assets/create', this.rateLimitMiddleware, this.slowDownMiddleware, (req, res, next) => this.assetService.saveAsset(req, res, next, false));
        this.app.get('/assets/create/result/:handler_id', (req, res, next) => this.assetService.getSaveAssetResult(req, res, next));
        this.app.post('/assets/update', this.rateLimitMiddleware, this.slowDownMiddleware, (req, res, next) => this.assetService.saveAsset(req, res, next, true));
        this.app.get('/assets/update/result/:handler_id', (req, res, next) => this.assetService.getSaveAssetResult(req, res, next));
        this.app.get('/assets/get', this.rateLimitMiddleware, this.slowDownMiddleware, (req, res, next) => this.assetService.getAsset(req, res, next));
